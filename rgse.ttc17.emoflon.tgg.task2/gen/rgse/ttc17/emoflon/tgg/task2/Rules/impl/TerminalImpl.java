...
public class TerminalImpl extends AbstractRuleImpl implements Terminal {
	...
	public boolean isAppropriate_FWD(Match match, gluemodel.CIM.IEC61970.Core.Terminal srcTerminal,
		...
		Object[] result1_black = TerminalImpl.pattern_Terminal_0_1_initialbindings_blackBBBBBBB(this, match,
				srcTerminal, srcResource, pair, srcLocation, meter);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [initial bindings] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[match] = " + match + ", " + "[srcTerminal] = " + srcTerminal + ", "
					+ "[srcResource] = " + srcResource + ", " + "[pair] = " + pair + ", " + "[srcLocation] = "
					+ srcLocation + ", " + "[meter] = " + meter + ".");
		}

		// Solve CSP
		Object[] result2_bindingAndBlack = TerminalImpl.pattern_Terminal_0_2_SolveCSP_bindingAndBlackFBBBBBBB(this,
				match, srcTerminal, srcResource, pair, srcLocation, meter);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [Solve CSP] failed." + " Variables: " + "[this] = "
					+ this + ", " + "[match] = " + match + ", " + "[srcTerminal] = " + srcTerminal + ", "
					+ "[srcResource] = " + srcResource + ", " + "[pair] = " + pair + ", " + "[srcLocation] = "
					+ srcLocation + ", " + "[meter] = " + meter + ".");
		}
		...
		if (TerminalImpl.pattern_Terminal_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			TerminalImpl.pattern_Terminal_0_5_collectcontextelements_greenBBBBBFFFFF(match, srcResource, pair,
					srcLocation, meter);
			// EMoflonEdge srcLocation__srcResource____PowerSystemResources = (EMoflonEdge) result5_green[5];
			// EMoflonEdge srcResource__srcLocation____Location = (EMoflonEdge) result5_green[6];
			...
			TerminalImpl.pattern_Terminal_0_6_registerobjectstomatch_expressionBBBBBBB(this, match, srcTerminal,
					srcResource, pair, srcLocation, meter);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		ConductingEquipment srcResource = (ConductingEquipment) result1_bindingAndBlack[1];
		...
		PowerSystemResourceToPowerSystemResource resourceToTResource = (PowerSystemResourceToPowerSystemResource) result1_bindingAndBlack[6];
		...
		Object[] result3_black = TerminalImpl.pattern_Terminal_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
				srcTerminal, trgTerminal, srcResource, pair, srcLocation, trgResource, terminalToTerminal, meter,
				resourceToTResource);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching in node [bookkeeping for edges] failed." + " Variables: "
					+ "[ruleresult] = " + ruleresult + ", " + "[srcTerminal] = " + srcTerminal + ", "
					+ "[trgTerminal] = " + trgTerminal + ", " + "[srcResource] = " + srcResource + ", " + "[pair] = "
					+ pair + ", " + "[srcLocation] = " + srcLocation + ", " + "[trgResource] = " + trgResource + ", "
					+ "[terminalToTerminal] = " + terminalToTerminal + ", " + "[meter] = " + meter + ", "
					+ "[resourceToTResource] = " + resourceToTResource + ".");
		}
		TerminalImpl.pattern_Terminal_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, srcTerminal, trgTerminal,
				srcResource, terminalToTerminal);
		...
		// EMoflonEdge terminalToTerminal__srcTerminal____source = (EMoflonEdge) result3_green[7];
		...
		TerminalImpl.pattern_Terminal_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, srcTerminal,
				trgTerminal, srcResource, pair, srcLocation, trgResource, terminalToTerminal, meter,
				resourceToTResource);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TerminalImpl.pattern_Terminal_2_2_corematch_blackBBBBFBFB(srcTerminal,
				srcResource, pair, srcLocation, meter, match)) {
			PowerSystemResource trgResource = (PowerSystemResource) result2_black[4];
			PowerSystemResourceToPowerSystemResource resourceToTResource = (PowerSystemResourceToPowerSystemResource) result2_black[6];
			// ForEach find context
			for (Object[] result3_black : TerminalImpl.pattern_Terminal_2_3_findcontext_blackBBBBBBB(srcTerminal,
					srcResource, pair, srcLocation, trgResource, meter, resourceToTResource)) {
				Object[] result3_green = TerminalImpl.pattern_Terminal_2_3_findcontext_greenBBBBBBBFFFFFFFFFF(
						srcTerminal, srcResource, pair, srcLocation, trgResource, meter, resourceToTResource);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				// EMoflonEdge srcResource__srcTerminal____Terminals = (EMoflonEdge) result3_green[8];
				// EMoflonEdge srcTerminal__srcResource____ConductingEquipment = (EMoflonEdge) result3_green[9];
				// EMoflonEdge srcLocation__srcResource____PowerSystemResources = (EMoflonEdge) result3_green[10];
				// EMoflonEdge srcResource__srcLocation____Location = (EMoflonEdge) result3_green[11];
				// EMoflonEdge pair__meter____a = (EMoflonEdge) result3_green[12];
				// EMoflonEdge resourceToTResource__trgResource____target = (EMoflonEdge) result3_green[13];
				...
				// EMoflonEdge resourceToTResource__srcResource____source = (EMoflonEdge) result3_green[16];

				// solve CSP
				Object[] result4_bindingAndBlack = TerminalImpl.pattern_Terminal_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
						this, isApplicableMatch, srcTerminal, srcResource, pair, srcLocation, trgResource, meter,
						resourceToTResource);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching in node [solve CSP] failed." + " Variables: "
							+ "[this] = " + this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ", "
							+ "[srcTerminal] = " + srcTerminal + ", " + "[srcResource] = " + srcResource + ", "
							+ "[pair] = " + pair + ", " + "[srcLocation] = " + srcLocation + ", " + "[trgResource] = "
							+ trgResource + ", " + "[meter] = " + meter + ", " + "[resourceToTResource] = "
							+ resourceToTResource + ".");
				}
	...
	public CSP isAppropriate_solveCsp_FWD(Match match, gluemodel.CIM.IEC61970.Core.Terminal srcTerminal,
			ConductingEquipment srcResource, MeterAssetMMXUPair pair, Location srcLocation, MeterAsset meter) {// Create CSP
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			gluemodel.CIM.IEC61970.Core.Terminal srcTerminal, ConductingEquipment srcResource, MeterAssetMMXUPair pair,
			Location srcLocation, PowerSystemResource trgResource, MeterAsset meter,
			PowerSystemResourceToPowerSystemResource resourceToTResource) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject srcTerminal, EObject trgTerminal,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_31(EMoflonEdge _edge_Terminals) {
		// prepare return value
		Object[] result1_bindingAndBlack = TerminalImpl
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(gluemodel.CIM.IEC61970.Core.Terminal srcTerminal, ConductingEquipment srcResource,
			MeterAssetMMXUPair pair, Location srcLocation, MeterAsset meter) {// match tgg pattern
		Object[] result1_black = TerminalImpl.pattern_Terminal_13_1_matchtggpattern_blackBBBBB(srcTerminal, srcResource,
				pair, srcLocation, meter);
		if (result1_black != null) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.TERMINAL___IS_APPROPRIATE_FWD__MATCH_TERMINAL_CONDUCTINGEQUIPMENT_METERASSETMMXUPAIR_LOCATION_METERASSET:
			return isAppropriate_FWD((Match) arguments.get(0), (gluemodel.CIM.IEC61970.Core.Terminal) arguments.get(1),
					(ConductingEquipment) arguments.get(2), (MeterAssetMMXUPair) arguments.get(3),
		...
		case RulesPackage.TERMINAL___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_TERMINAL_CONDUCTINGEQUIPMENT_METERASSETMMXUPAIR_LOCATION_METERASSET:
			registerObjectsToMatch_FWD((Match) arguments.get(0),
					(gluemodel.CIM.IEC61970.Core.Terminal) arguments.get(1), (ConductingEquipment) arguments.get(2),
					(MeterAssetMMXUPair) arguments.get(3), (Location) arguments.get(4), (MeterAsset) arguments.get(5));
			return null;
		case RulesPackage.TERMINAL___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_TERMINAL_CONDUCTINGEQUIPMENT_METERASSETMMXUPAIR_LOCATION_METERASSET:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0),
					(gluemodel.CIM.IEC61970.Core.Terminal) arguments.get(1), (ConductingEquipment) arguments.get(2),
					(MeterAssetMMXUPair) arguments.get(3), (Location) arguments.get(4), (MeterAsset) arguments.get(5));
		case RulesPackage.TERMINAL___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.TERMINAL___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TERMINAL_CONDUCTINGEQUIPMENT_METERASSETMMXUPAIR_LOCATION_POWERSYSTEMRESOURCE_METERASSET_POWERSYSTEMRESOURCETOPOWERSYSTEMRESOURCE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(gluemodel.CIM.IEC61970.Core.Terminal) arguments.get(1), (ConductingEquipment) arguments.get(2),
					(MeterAssetMMXUPair) arguments.get(3), (Location) arguments.get(4),
					(PowerSystemResource) arguments.get(5), (MeterAsset) arguments.get(6),
					(PowerSystemResourceToPowerSystemResource) arguments.get(7));
		...
		case RulesPackage.TERMINAL___IS_APPROPRIATE_FWD_EMOFLON_EDGE_31__EMOFLONEDGE:
		...
		case RulesPackage.TERMINAL___CHECK_DEC_FWD__TERMINAL_CONDUCTINGEQUIPMENT_METERASSETMMXUPAIR_LOCATION_METERASSET:
			return checkDEC_FWD((gluemodel.CIM.IEC61970.Core.Terminal) arguments.get(0),
					(ConductingEquipment) arguments.get(1), (MeterAssetMMXUPair) arguments.get(2),
					(Location) arguments.get(3), (MeterAsset) arguments.get(4));
		}
	...
	public static final Object[] pattern_Terminal_0_1_initialbindings_blackBBBBBBB(Terminal _this, Match match,
			gluemodel.CIM.IEC61970.Core.Terminal srcTerminal, ConductingEquipment srcResource, MeterAssetMMXUPair pair,
			Location srcLocation, MeterAsset meter) {
		return new Object[] { _this, match, srcTerminal, srcResource, pair, srcLocation, meter };
	}

	public static final Object[] pattern_Terminal_0_2_SolveCSP_bindingFBBBBBBB(Terminal _this, Match match,
			gluemodel.CIM.IEC61970.Core.Terminal srcTerminal, ConductingEquipment srcResource, MeterAssetMMXUPair pair,
			Location srcLocation, MeterAsset meter) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, srcTerminal, srcResource, pair, srcLocation,
				meter);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, srcTerminal, srcResource, pair, srcLocation, meter };
		}
		return null;
	}
	...
	public static final Object[] pattern_Terminal_0_4_collectelementstobetranslated_blackBBBBBB(Match match,
			gluemodel.CIM.IEC61970.Core.Terminal srcTerminal, ConductingEquipment srcResource, MeterAssetMMXUPair pair,
			Location srcLocation, MeterAsset meter) {
		return new Object[] { match, srcTerminal, srcResource, pair, srcLocation, meter };
	}
	...
	public static final Object[] pattern_Terminal_0_5_collectcontextelements_greenBBBBBFFFFF(Match match,
		...
		return new Object[] { match, srcResource, pair, srcLocation, meter,
	...
	public static final void pattern_Terminal_0_6_registerobjectstomatch_expressionBBBBBBB(Terminal _this, Match match,
			gluemodel.CIM.IEC61970.Core.Terminal srcTerminal, ConductingEquipment srcResource, MeterAssetMMXUPair pair,
			Location srcLocation, MeterAsset meter) {
		_this.registerObjectsToMatch_FWD(match, srcTerminal, srcResource, pair, srcLocation, meter);
	...
	public static final Object[] pattern_Terminal_1_1_performtransformation_bindingFFFFFFFB(
		...
		EObject _localVariable_6 = isApplicableMatch.getObject("resourceToTResource");
		...
		EObject tmpResourceToTResource = _localVariable_6;
						...
						if (tmpTrgResource instanceof PowerSystemResource) {
							...
							if (tmpMeter instanceof MeterAsset) {
								...
								if (tmpResourceToTResource instanceof PowerSystemResourceToPowerSystemResource) {
									...
									return new Object[] { srcTerminal, srcResource, pair, srcLocation, trgResource,
											meter, resourceToTResource, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_Terminal_1_1_performtransformation_blackBBBBBBBFBB(
			gluemodel.CIM.IEC61970.Core.Terminal srcTerminal, ConductingEquipment srcResource, MeterAssetMMXUPair pair,
			Location srcLocation, PowerSystemResource trgResource, MeterAsset meter,
			PowerSystemResourceToPowerSystemResource resourceToTResource, Terminal _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { srcTerminal, srcResource, pair, srcLocation, trgResource, meter,
						resourceToTResource, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_Terminal_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(Terminal _this,
		...
		if (result_pattern_Terminal_1_1_performtransformation_binding != null) {
			...
			ConductingEquipment srcResource = (ConductingEquipment) result_pattern_Terminal_1_1_performtransformation_binding[1];
			MeterAssetMMXUPair pair = (MeterAssetMMXUPair) result_pattern_Terminal_1_1_performtransformation_binding[2];
			Location srcLocation = (Location) result_pattern_Terminal_1_1_performtransformation_binding[3];
			...
			PowerSystemResourceToPowerSystemResource resourceToTResource = (PowerSystemResourceToPowerSystemResource) result_pattern_Terminal_1_1_performtransformation_binding[6];
			...
			Object[] result_pattern_Terminal_1_1_performtransformation_black = pattern_Terminal_1_1_performtransformation_blackBBBBBBBFBB(
					srcTerminal, srcResource, pair, srcLocation, trgResource, meter, resourceToTResource, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_Terminal_1_3_bookkeepingforedges_blackBBBBBBBBBB(PerformRuleResult ruleresult,
			EObject srcTerminal, EObject trgTerminal, EObject srcResource, EObject pair, EObject srcLocation,
			EObject trgResource, EObject terminalToTerminal, EObject meter, EObject resourceToTResource) {
					...
					if (!srcResource.equals(srcTerminal)) {
						if (!srcResource.equals(trgTerminal)) {
							if (!srcResource.equals(trgResource)) {
								if (!srcResource.equals(terminalToTerminal)) {
	...
	public static final Object[] pattern_Terminal_1_3_bookkeepingforedges_greenBBBBBFFFF(PerformRuleResult ruleresult,
			EObject srcTerminal, EObject trgTerminal, EObject srcResource, EObject terminalToTerminal) {
		EMoflonEdge srcResource__srcTerminal____Terminals = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge srcTerminal__srcResource____ConductingEquipment = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, srcTerminal, trgTerminal, srcResource, terminalToTerminal,
				srcResource__srcTerminal____Terminals, srcTerminal__srcResource____ConductingEquipment,
				terminalToTerminal__srcTerminal____source, terminalToTerminal__trgTerminal____target };
	}

	public static final void pattern_Terminal_1_5_registerobjects_expressionBBBBBBBBBBB(Terminal _this,
			PerformRuleResult ruleresult, EObject srcTerminal, EObject trgTerminal, EObject srcResource, EObject pair,
			EObject srcLocation, EObject trgResource, EObject terminalToTerminal, EObject meter,
			EObject resourceToTResource) {
		_this.registerObjects_FWD(ruleresult, srcTerminal, trgTerminal, srcResource, pair, srcLocation, trgResource,
				terminalToTerminal, meter, resourceToTResource);
			...
			if (tmpSrcResource instanceof ConductingEquipment) {
				...
				if (tmpPair instanceof MeterAssetMMXUPair) {
					...
					if (tmpSrcLocation instanceof Location) {
						...
						if (tmpMeter instanceof MeterAsset) {
							MeterAsset meter = (MeterAsset) tmpMeter;
							return new Object[] { srcTerminal, srcResource, pair, srcLocation, meter, match };
						}
					}
				}
			}
	...
	public static final Iterable<Object[]> pattern_Terminal_2_2_corematch_blackBBBBFBFB(
			gluemodel.CIM.IEC61970.Core.Terminal srcTerminal, ConductingEquipment srcResource, MeterAssetMMXUPair pair,
			Location srcLocation, MeterAsset meter, Match match) {
		...
		for (PowerSystemResourceToPowerSystemResource resourceToTResource : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (trgResource != null) {
				_result.add(new Object[] { srcTerminal, srcResource, pair, srcLocation, trgResource, meter,
						resourceToTResource, match });
			}
					...
					if (trgResource.equals(resourceToTResource.getTarget())) {
						if (srcLocation.equals(meter.getLocation())) {
							if (srcResource.equals(resourceToTResource.getSource())) {
								_result.add(new Object[] { srcTerminal, srcResource, pair, srcLocation, trgResource,
										meter, resourceToTResource });
							}
						}
					}
				}
	...
	public static final Object[] pattern_Terminal_2_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		return new Object[] { srcTerminal, srcResource, pair, srcLocation, trgResource, meter, resourceToTResource,
				isApplicableMatch, srcResource__srcTerminal____Terminals,
				srcTerminal__srcResource____ConductingEquipment, srcLocation__srcResource____PowerSystemResources,
				srcResource__srcLocation____Location, pair__meter____a, resourceToTResource__trgResource____target,
				meter__srcLocation____Location, srcLocation__meter____Assets,
				resourceToTResource__srcResource____source };
	}
	...
	public static final Object[] pattern_Terminal_2_4_solveCSP_bindingFBBBBBBBBB(Terminal _this,
			...
			PowerSystemResourceToPowerSystemResource resourceToTResource) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, srcTerminal, srcResource, pair,
				srcLocation, trgResource, meter, resourceToTResource);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, srcTerminal, srcResource, pair, srcLocation,
					trgResource, meter, resourceToTResource };
		}
		return null;
	}
	...
	public static final Object[] pattern_Terminal_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(Terminal _this,
		...
		Object[] result_pattern_Terminal_2_4_solveCSP_binding = pattern_Terminal_2_4_solveCSP_bindingFBBBBBBBBB(_this,
				isApplicableMatch, srcTerminal, srcResource, pair, srcLocation, trgResource, meter,
				resourceToTResource);
	...
	public static final Object[] pattern_Terminal_10_2_testcorematchandDECs_black_nac_0BB(
			gluemodel.CIM.IEC61970.Core.Terminal srcTerminal, ConductingEquipment srcResource) {
		ConductingEquipment __DEC_srcTerminal_Terminals_771080 = srcTerminal.getConductingEquipment();
		if (__DEC_srcTerminal_Terminals_771080 != null) {
			if (!srcResource.equals(__DEC_srcTerminal_Terminals_771080)) {
							...
							for (Asset tmpMeter : srcLocation.getAssets()) {
								if (tmpMeter instanceof MeterAsset) {
									...
									for (MeterAssetMMXUPair pair : org.moflon.core.utilities.eMoflonEMFUtil
										...
										_result.add(new Object[] { srcTerminal, srcResource, pair, srcLocation, meter,
												_edge_Terminals });
									}
								}
							}
	...
	public static final boolean pattern_Terminal_10_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			Terminal _this, Match match, gluemodel.CIM.IEC61970.Core.Terminal srcTerminal,
			ConductingEquipment srcResource, MeterAssetMMXUPair pair, Location srcLocation, MeterAsset meter) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, srcTerminal, srcResource, pair, srcLocation, meter);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_Terminal_13_1_matchtggpattern_black_nac_0BB(
			gluemodel.CIM.IEC61970.Core.Terminal srcTerminal, ConductingEquipment srcResource) {
		ConductingEquipment __DEC_srcTerminal_Terminals_912262 = srcTerminal.getConductingEquipment();
		if (__DEC_srcTerminal_Terminals_912262 != null) {
			if (!srcResource.equals(__DEC_srcTerminal_Terminals_912262)) {
				return new Object[] { srcTerminal, srcResource };
			}
		}
				...
				if (meter.equals(pair.getA())) {
					if (srcLocation.equals(meter.getLocation())) {
						if (pattern_Terminal_13_1_matchtggpattern_black_nac_0BB(srcTerminal, srcResource) == null) {
							return new Object[] { srcTerminal, srcResource, pair, srcLocation, meter };
						}
					}
				}
			}
