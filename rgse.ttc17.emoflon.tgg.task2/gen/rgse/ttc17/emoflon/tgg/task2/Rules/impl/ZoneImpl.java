...
public class ZoneImpl extends AbstractRuleImpl implements Zone {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		ZoneImpl.pattern_Zone_1_5_registerobjects_expressionBBBBBBBBB(this, ruleresult, trgLocation, srcLocation, asset,
				assetToPMU, pair, consumer, locationCorr);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ZoneImpl.pattern_Zone_2_2_corematch_blackBBFBFB(srcLocation, asset, pair,
				match)) {
			...
			for (Object[] result3_black : ZoneImpl.pattern_Zone_2_3_findcontext_blackBBBBB(srcLocation, asset,
					assetToPMU, pair, consumer)) {
				...
				Object[] result4_bindingAndBlack = ZoneImpl.pattern_Zone_2_4_solveCSP_bindingAndBlackFBBBBBBB(this,
						isApplicableMatch, srcLocation, asset, assetToPMU, pair, consumer);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_28(EMoflonEdge _edge_Location) {
		// prepare return value
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ZONE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ZONE_METERASSET_METERASSETTOPMUVOLTAGEMETER_METERASSETMMXUPAIR_PMUVOLTAGEMETER:
		...
		case RulesPackage.ZONE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_28__EMOFLONEDGE:
	...
	public static final Object[] pattern_Zone_1_1_performtransformation_blackBBBBBFBB(
			gluemodel.CIM.IEC61970.Informative.InfLocations.Zone srcLocation, MeterAsset asset,
			MeterAssetToPMUVoltageMeter assetToPMU, MeterAssetMMXUPair pair, PMUVoltageMeter consumer, Zone _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_Zone_1_1_performtransformation_bindingAndBlackFFFFFFBB(Zone _this,
		...
		if (result_pattern_Zone_1_1_performtransformation_binding != null) {
			...
			MeterAssetToPMUVoltageMeter assetToPMU = (MeterAssetToPMUVoltageMeter) result_pattern_Zone_1_1_performtransformation_binding[2];
			MeterAssetMMXUPair pair = (MeterAssetMMXUPair) result_pattern_Zone_1_1_performtransformation_binding[3];
			PMUVoltageMeter consumer = (PMUVoltageMeter) result_pattern_Zone_1_1_performtransformation_binding[4];
	...
	public static final Iterable<Object[]> pattern_Zone_2_2_corematch_blackBBFBFB(
