package rgse.ttc17.emoflon.tgg.task1.org.moflon.tie;
...
public class Task1Sync extends SynchronizationHelper {
	...
	public Task1Sync(boolean debug) throws IOException {
	...
	private void initialize(boolean debug) throws IOException {
		...
		if (debug) {
			...
			loadRulesFromJarArchive(Task1Sync.class.getProtectionDomain().getCodeSource().getLocation().getPath(),
					"Task1.sma.xmi");
		}
		...
		recursiveLoad(OutageDetectionJointargetPackage.eINSTANCE, getResourceSet());
