...
import rgse.ttc17.emoflon.tgg.task1.Rules.Zone;
...
public class ZoneImpl extends AbstractRuleImpl implements Zone {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		gluemodel.CIM.IEC61970.Informative.InfLocations.Zone srcLocation = (gluemodel.CIM.IEC61970.Informative.InfLocations.Zone) result1_bindingAndBlack[1];
		...
		// register objects
		ZoneImpl.pattern_Zone_1_5_registerobjects_expressionBBBBBBBBB(this, ruleresult, trgLocation, assetToConumer,
				srcLocation, asset, consumer, pair, srcLocationCorr);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ZoneImpl.pattern_Zone_2_2_corematch_blackFBBFBB(srcLocation, asset, pair,
				match)) {
			...
			for (Object[] result3_black : ZoneImpl.pattern_Zone_2_3_findcontext_blackBBBBB(assetToConumer, srcLocation,
					asset, consumer, pair)) {
				Object[] result3_green = ZoneImpl.pattern_Zone_2_3_findcontext_greenBBBBBFFFFFF(assetToConumer,
				...
				Object[] result4_bindingAndBlack = ZoneImpl.pattern_Zone_2_4_solveCSP_bindingAndBlackFBBBBBBB(this,
						isApplicableMatch, assetToConumer, srcLocation, asset, consumer, pair);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MeterAssetToEnergyConsumer assetToConumer,
			gluemodel.CIM.IEC61970.Informative.InfLocations.Zone srcLocation, MeterAsset asset, EnergyConsumer consumer,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_12(EMoflonEdge _edge_Location) {
		// prepare return value
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.ZONE___IS_APPROPRIATE_FWD__MATCH_ZONE_METERASSET_METERASSETPHYSICALDEVICEPAIR:
		...
		case RulesPackage.ZONE___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_ZONE_METERASSET_METERASSETPHYSICALDEVICEPAIR:
			registerObjectsToMatch_FWD((Match) arguments.get(0),
					(gluemodel.CIM.IEC61970.Informative.InfLocations.Zone) arguments.get(1),
					(MeterAsset) arguments.get(2), (MeterAssetPhysicalDevicePair) arguments.get(3));
			return null;
		case RulesPackage.ZONE___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_ZONE_METERASSET_METERASSETPHYSICALDEVICEPAIR:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0),
					(gluemodel.CIM.IEC61970.Informative.InfLocations.Zone) arguments.get(1),
					(MeterAsset) arguments.get(2), (MeterAssetPhysicalDevicePair) arguments.get(3));
		case RulesPackage.ZONE___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.ZONE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_METERASSETTOENERGYCONSUMER_ZONE_METERASSET_ENERGYCONSUMER_METERASSETPHYSICALDEVICEPAIR:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MeterAssetToEnergyConsumer) arguments.get(1),
					(gluemodel.CIM.IEC61970.Informative.InfLocations.Zone) arguments.get(2),
		...
		case RulesPackage.ZONE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_12__EMOFLONEDGE:
		...
		case RulesPackage.ZONE___CHECK_DEC_FWD__ZONE_METERASSET_METERASSETPHYSICALDEVICEPAIR:
	...
	public static final Object[] pattern_Zone_1_1_performtransformation_blackBBBBBFBB(
			MeterAssetToEnergyConsumer assetToConumer, gluemodel.CIM.IEC61970.Informative.InfLocations.Zone srcLocation,
			MeterAsset asset, EnergyConsumer consumer, MeterAssetPhysicalDevicePair pair, Zone _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_Zone_1_1_performtransformation_bindingAndBlackFFFFFFBB(Zone _this,
		...
		if (result_pattern_Zone_1_1_performtransformation_binding != null) {
			MeterAssetToEnergyConsumer assetToConumer = (MeterAssetToEnergyConsumer) result_pattern_Zone_1_1_performtransformation_binding[0];
			gluemodel.CIM.IEC61970.Informative.InfLocations.Zone srcLocation = (gluemodel.CIM.IEC61970.Informative.InfLocations.Zone) result_pattern_Zone_1_1_performtransformation_binding[1];
			MeterAsset asset = (MeterAsset) result_pattern_Zone_1_1_performtransformation_binding[2];
			EnergyConsumer consumer = (EnergyConsumer) result_pattern_Zone_1_1_performtransformation_binding[3];
			MeterAssetPhysicalDevicePair pair = (MeterAssetPhysicalDevicePair) result_pattern_Zone_1_1_performtransformation_binding[4];
	...
	public static final Object[] pattern_Zone_1_1_performtransformation_greenFBBF(
			gluemodel.CIM.IEC61970.Informative.InfLocations.Zone srcLocation, EnergyConsumer consumer) {
	...
	public static final Object[] pattern_Zone_1_2_collecttranslatedelements_blackBBB(Location trgLocation,
			gluemodel.CIM.IEC61970.Informative.InfLocations.Zone srcLocation, LocationToLocation srcLocationCorr) {
	...
	public static final Object[] pattern_Zone_1_3_bookkeepingforedges_greenBBBBBBFFFFF(PerformRuleResult ruleresult,
			EObject trgLocation, EObject srcLocation, EObject asset, EObject consumer, EObject srcLocationCorr) {
	...
	public static final Iterable<Object[]> pattern_Zone_2_2_corematch_blackFBBFBB(
			gluemodel.CIM.IEC61970.Informative.InfLocations.Zone srcLocation, MeterAsset asset,
