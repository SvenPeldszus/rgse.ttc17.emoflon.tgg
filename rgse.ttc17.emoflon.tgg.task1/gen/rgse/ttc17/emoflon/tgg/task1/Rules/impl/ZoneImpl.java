...
public class ZoneImpl extends AbstractRuleImpl implements Zone {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		ZoneImpl.pattern_Zone_1_5_registerobjects_expressionBBBBBBBBB(this, ruleresult, trgLocation, assetToConumer,
				srcLocation, asset, pair, consumer, srcLocationCorr);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ZoneImpl.pattern_Zone_2_2_corematch_blackFBBBFB(srcLocation, asset, pair,
				match)) {
			...
			for (Object[] result3_black : ZoneImpl.pattern_Zone_2_3_findcontext_blackBBBBB(assetToConumer, srcLocation,
				...
				Object[] result4_bindingAndBlack = ZoneImpl.pattern_Zone_2_4_solveCSP_bindingAndBlackFBBBBBBB(this,
						isApplicableMatch, assetToConumer, srcLocation, asset, pair, consumer);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ZONE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_METERASSETTOENERGYCONSUMER_ZONE_METERASSET_METERASSETPHYSICALDEVICEPAIR_ENERGYCONSUMER:
	...
	public static final Object[] pattern_Zone_1_1_performtransformation_blackBBBBBFBB(
			...
			MeterAsset asset, MeterAssetPhysicalDevicePair pair, EnergyConsumer consumer, Zone _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_Zone_1_1_performtransformation_bindingAndBlackFFFFFFBB(Zone _this,
		...
		if (result_pattern_Zone_1_1_performtransformation_binding != null) {
			...
			MeterAssetPhysicalDevicePair pair = (MeterAssetPhysicalDevicePair) result_pattern_Zone_1_1_performtransformation_binding[3];
			EnergyConsumer consumer = (EnergyConsumer) result_pattern_Zone_1_1_performtransformation_binding[4];
	...
	public static final Iterable<Object[]> pattern_Zone_2_2_corematch_blackFBBBFB(
			gluemodel.CIM.IEC61970.Informative.InfLocations.Zone srcLocation, MeterAsset asset,
