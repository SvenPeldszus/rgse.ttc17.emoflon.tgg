...
public class ServiceLocationImpl extends AbstractRuleImpl implements ServiceLocation {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ServiceLocationImpl.pattern_ServiceLocation_1_3_bookkeepingforedges_blackBBBBBBBB(
				ruleresult, trgLocation, assetToConumer, srcLocation, asset, pair, consumer, srcLocationCorr);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ServiceLocationImpl.pattern_ServiceLocation_2_2_corematch_blackFBBBFB(srcLocation,
				asset, pair, match)) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.SERVICE_LOCATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_METERASSETTOENERGYCONSUMER_SERVICELOCATION_METERASSET_METERASSETPHYSICALDEVICEPAIR_ENERGYCONSUMER:
	...
	public static final Object[] pattern_ServiceLocation_1_1_performtransformation_blackBBBBBFBB(
			...
			MeterAsset asset, MeterAssetPhysicalDevicePair pair, EnergyConsumer consumer, ServiceLocation _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_ServiceLocation_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_ServiceLocation_1_1_performtransformation_binding != null) {
			...
			MeterAssetPhysicalDevicePair pair = (MeterAssetPhysicalDevicePair) result_pattern_ServiceLocation_1_1_performtransformation_binding[3];
			EnergyConsumer consumer = (EnergyConsumer) result_pattern_ServiceLocation_1_1_performtransformation_binding[4];
	...
	public static final Iterable<Object[]> pattern_ServiceLocation_2_2_corematch_blackFBBBFB(
			gluemodel.CIM.IEC61968.Customers.ServiceLocation srcLocation, MeterAsset asset,
