...
import rgse.ttc17.emoflon.tgg.task2.Rules.SDPLocation;
...
public class SDPLocationImpl extends AbstractRuleImpl implements SDPLocation {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		gluemodel.CIM.IEC61968.Metering.SDPLocation srcLocation = (gluemodel.CIM.IEC61968.Metering.SDPLocation) result1_bindingAndBlack[0];
		...
		Object[] result2_green = SDPLocationImpl
				.pattern_SDPLocation_1_2_collecttranslatedelements_greenFBBB(trgLocation, srcLocation, locationCorr);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : SDPLocationImpl.pattern_SDPLocation_2_2_corematch_blackBBFBFB(srcLocation, asset,
				pair, match)) {
			...
			for (Object[] result3_black : SDPLocationImpl.pattern_SDPLocation_2_3_findcontext_blackBBBBB(srcLocation,
				...
				Object[] result4_bindingAndBlack = SDPLocationImpl
						.pattern_SDPLocation_2_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, srcLocation,
								asset, assetToPMU, pair, consumer);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_47(EMoflonEdge _edge_Location) {
		// prepare return value
		Object[] result1_bindingAndBlack = SDPLocationImpl
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.SDP_LOCATION___IS_APPROPRIATE_FWD__MATCH_SDPLOCATION_METERASSET_METERASSETMMXUPAIR:
		...
		case RulesPackage.SDP_LOCATION___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_SDPLOCATION_METERASSET_METERASSETMMXUPAIR:
			registerObjectsToMatch_FWD((Match) arguments.get(0),
					(gluemodel.CIM.IEC61968.Metering.SDPLocation) arguments.get(1), (MeterAsset) arguments.get(2),
					(MeterAssetMMXUPair) arguments.get(3));
			return null;
		case RulesPackage.SDP_LOCATION___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_SDPLOCATION_METERASSET_METERASSETMMXUPAIR:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0),
					(gluemodel.CIM.IEC61968.Metering.SDPLocation) arguments.get(1), (MeterAsset) arguments.get(2),
					(MeterAssetMMXUPair) arguments.get(3));
		case RulesPackage.SDP_LOCATION___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.SDP_LOCATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_SDPLOCATION_METERASSET_METERASSETTOPMUVOLTAGEMETER_METERASSETMMXUPAIR_PMUVOLTAGEMETER:
		...
		case RulesPackage.SDP_LOCATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_47__EMOFLONEDGE:
		...
		case RulesPackage.SDP_LOCATION___CHECK_DEC_FWD__SDPLOCATION_METERASSET_METERASSETMMXUPAIR:
	...
	public static final Object[] pattern_SDPLocation_0_1_initialbindings_blackBBBBB(SDPLocation _this, Match match,
			gluemodel.CIM.IEC61968.Metering.SDPLocation srcLocation, MeterAsset asset, MeterAssetMMXUPair pair) {
	...
	public static final Object[] pattern_SDPLocation_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_SDPLocation_1_1_performtransformation_binding != null) {
			gluemodel.CIM.IEC61968.Metering.SDPLocation srcLocation = (gluemodel.CIM.IEC61968.Metering.SDPLocation) result_pattern_SDPLocation_1_1_performtransformation_binding[0];
			MeterAsset asset = (MeterAsset) result_pattern_SDPLocation_1_1_performtransformation_binding[1];
			MeterAssetToPMUVoltageMeter assetToPMU = (MeterAssetToPMUVoltageMeter) result_pattern_SDPLocation_1_1_performtransformation_binding[2];
			MeterAssetMMXUPair pair = (MeterAssetMMXUPair) result_pattern_SDPLocation_1_1_performtransformation_binding[3];
			PMUVoltageMeter consumer = (PMUVoltageMeter) result_pattern_SDPLocation_1_1_performtransformation_binding[4];
	...
	public static final Object[] pattern_SDPLocation_1_1_performtransformation_greenFBBF(
			gluemodel.CIM.IEC61968.Metering.SDPLocation srcLocation, PMUVoltageMeter consumer) {
	...
	public static final Object[] pattern_SDPLocation_1_2_collecttranslatedelements_blackBBB(Location trgLocation,
			gluemodel.CIM.IEC61968.Metering.SDPLocation srcLocation, LocationToLocation locationCorr) {
	...
	public static final Object[] pattern_SDPLocation_1_3_bookkeepingforedges_blackBBBBBBBB(PerformRuleResult ruleresult,
			EObject trgLocation, EObject srcLocation, EObject asset, EObject assetToPMU, EObject pair, EObject consumer,
	...
	public static final Iterable<Object[]> pattern_SDPLocation_2_2_corematch_blackBBFBFB(
			gluemodel.CIM.IEC61968.Metering.SDPLocation srcLocation, MeterAsset asset, MeterAssetMMXUPair pair,
			Match match) {
	...
	public static final Object[] pattern_SDPLocation_2_4_solveCSP_bindingFBBBBBBB(SDPLocation _this,
			IsApplicableMatch isApplicableMatch, gluemodel.CIM.IEC61968.Metering.SDPLocation srcLocation,
