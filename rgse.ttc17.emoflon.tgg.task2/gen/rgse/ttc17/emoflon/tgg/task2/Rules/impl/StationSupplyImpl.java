...
import rgse.ttc17.emoflon.tgg.task2.Rules.StationSupply;
 ...
 * @generated
 */
public class StationSupplyImpl extends AbstractRuleImpl implements StationSupply {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return RulesPackage.eINSTANCE.getStationSupply();
	}
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer,
			ServiceDeliveryPoint srcDeliver, MeterAsset asset, MeterAssetPhysicalDevicePair pair) {
		// initial bindings
		Object[] result1_black = StationSupplyImpl.pattern_StationSupply_0_1_initialbindings_blackBBBBBB(this, match,
		...
		// Solve CSP
		Object[] result2_bindingAndBlack = StationSupplyImpl.pattern_StationSupply_0_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		// Check CSP
		if (StationSupplyImpl.pattern_StationSupply_0_3_CheckCSP_expressionFBB(this, csp)) {

			// collect elements to be translated
			Object[] result4_black = StationSupplyImpl
					.pattern_StationSupply_0_4_collectelementstobetranslated_blackBBBBB(match, srcConsumer, srcDeliver,
							asset, pair);
			...
			StationSupplyImpl.pattern_StationSupply_0_4_collectelementstobetranslated_greenBBBFF(match, srcConsumer,
					srcDeliver);
			...
			Object[] result5_black = StationSupplyImpl.pattern_StationSupply_0_5_collectcontextelements_blackBBBBB(
			...
			StationSupplyImpl.pattern_StationSupply_0_5_collectcontextelements_greenBBBBFFF(match, srcDeliver, asset,
					pair);
			...
			StationSupplyImpl.pattern_StationSupply_0_6_registerobjectstomatch_expressionBBBBBB(this, match,
					srcConsumer, srcDeliver, asset, pair);
			return StationSupplyImpl.pattern_StationSupply_0_7_expressionF();
		} else {
			return StationSupplyImpl.pattern_StationSupply_0_8_expressionF();
		}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = StationSupplyImpl
				.pattern_StationSupply_1_1_performtransformation_bindingAndBlackFFFFFFFBB(this, isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [perform transformation] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
		}
		gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer = (gluemodel.CIM.IEC61970.LoadModel.StationSupply) result1_bindingAndBlack[0];
		...
		Object[] result1_green = StationSupplyImpl
				.pattern_StationSupply_1_1_performtransformation_greenBBFFB(srcConsumer, trgDeliver, csp);
		EnergyConsumerToEnergyConsumer consumerToConsumer = (EnergyConsumerToEnergyConsumer) result1_green[2];
		EnergyConsumer trgConsumer = (EnergyConsumer) result1_green[3];

		// collect translated elements
		Object[] result2_black = StationSupplyImpl.pattern_StationSupply_1_2_collecttranslatedelements_blackBBB(
		...
		Object[] result2_green = StationSupplyImpl.pattern_StationSupply_1_2_collecttranslatedelements_greenFBBB(
				srcConsumer, consumerToConsumer, trgConsumer);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = StationSupplyImpl.pattern_StationSupply_1_3_bookkeepingforedges_blackBBBBBBBBB(
		...
		StationSupplyImpl.pattern_StationSupply_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, srcConsumer,
		...
		// register objects
		StationSupplyImpl.pattern_StationSupply_1_5_registerobjects_expressionBBBBBBBBBB(this, ruleresult, srcConsumer,
				srcDeliver, trgDeliver, deliverToDeliver, consumerToConsumer, asset, pair, trgConsumer);
		return StationSupplyImpl.pattern_StationSupply_1_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result1_bindingAndBlack = StationSupplyImpl
				.pattern_StationSupply_2_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
		...
		Object[] result1_green = StationSupplyImpl
				.pattern_StationSupply_2_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach core match
		Object[] result2_binding = StationSupplyImpl.pattern_StationSupply_2_2_corematch_bindingFFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer = (gluemodel.CIM.IEC61970.LoadModel.StationSupply) result2_binding[0];
		...
		for (Object[] result2_black : StationSupplyImpl.pattern_StationSupply_2_2_corematch_blackBBFFBBB(srcConsumer,
			...
			for (Object[] result3_black : StationSupplyImpl.pattern_StationSupply_2_3_findcontext_blackBBBBBB(
					srcConsumer, srcDeliver, trgDeliver, deliverToDeliver, asset, pair)) {
				Object[] result3_green = StationSupplyImpl.pattern_StationSupply_2_3_findcontext_greenBBBBBBFFFFFFFF(
						srcConsumer, srcDeliver, trgDeliver, deliverToDeliver, asset, pair);
				...
				// solve CSP
				Object[] result4_bindingAndBlack = StationSupplyImpl
						.pattern_StationSupply_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								srcConsumer, srcDeliver, trgDeliver, deliverToDeliver, asset, pair);
				...
				// check CSP
				if (StationSupplyImpl.pattern_StationSupply_2_5_checkCSP_expressionFBB(this, csp)) {

					// add match to rule result
					Object[] result6_black = StationSupplyImpl
							.pattern_StationSupply_2_6_addmatchtoruleresult_blackBB(ruleresult, isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching in node [add match to rule result] failed."
								+ " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[isApplicableMatch] = "
								+ isApplicableMatch + ".");
					}
					StationSupplyImpl.pattern_StationSupply_2_6_addmatchtoruleresult_greenBB(ruleresult,
							isApplicableMatch);
		...
		return StationSupplyImpl.pattern_StationSupply_2_7_expressionFB(ruleresult);
	}
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer,
			ServiceDeliveryPoint srcDeliver, MeterAsset asset, MeterAssetPhysicalDevicePair pair) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer,
	...
	public boolean checkTypes_FWD(Match match) {
		return true && org.moflon.util.eMoflonSDMUtil.getFQN(match.getObject("srcConsumer").eClass())
				.equals("gluemodel.CIM.IEC61970.LoadModel.StationSupply.");
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_38(EMoflonEdge _edge_EnergyConsumer) {
		...
		Object[] result1_green = StationSupplyImpl.pattern_StationSupply_10_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : StationSupplyImpl
				.pattern_StationSupply_10_2_testcorematchandDECs_blackFFFFB(_edge_EnergyConsumer)) {
			gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer = (gluemodel.CIM.IEC61970.LoadModel.StationSupply) result2_black[0];
			...
			Object[] result2_green = StationSupplyImpl
					.pattern_StationSupply_10_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (StationSupplyImpl
					.pattern_StationSupply_10_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(this, match,
							srcConsumer, srcDeliver, asset, pair)) {
				// Ensure that the correct types of elements are matched
				if (StationSupplyImpl
						.pattern_StationSupply_10_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(this,
								match)) {

					// Add match to rule result
					Object[] result5_black = StationSupplyImpl
							.pattern_StationSupply_10_5_Addmatchtoruleresult_blackBBBB(match, __performOperation,
					...
					StationSupplyImpl.pattern_StationSupply_10_5_Addmatchtoruleresult_greenBBBB(match,
		...
		return StationSupplyImpl.pattern_StationSupply_10_6_expressionFB(__result);
	}
	...
	public AttributeConstraintsRuleResult checkAttributes_FWD(TripleMatch __tripleMatch) {
		...
		ruleResult.setRule("StationSupply");
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer,
			ServiceDeliveryPoint srcDeliver, MeterAsset asset, MeterAssetPhysicalDevicePair pair) {// match tgg pattern
		Object[] result1_black = StationSupplyImpl.pattern_StationSupply_13_1_matchtggpattern_blackBBBB(srcConsumer,
				srcDeliver, asset, pair);
		if (result1_black != null) {
			return StationSupplyImpl.pattern_StationSupply_13_2_expressionF();
		} else {
			return StationSupplyImpl.pattern_StationSupply_13_3_expressionF();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.STATION_SUPPLY___IS_APPROPRIATE_FWD__MATCH_STATIONSUPPLY_SERVICEDELIVERYPOINT_METERASSET_METERASSETPHYSICALDEVICEPAIR:
			return isAppropriate_FWD((Match) arguments.get(0),
					(gluemodel.CIM.IEC61970.LoadModel.StationSupply) arguments.get(1),
					(ServiceDeliveryPoint) arguments.get(2), (MeterAsset) arguments.get(3),
					(MeterAssetPhysicalDevicePair) arguments.get(4));
		case RulesPackage.STATION_SUPPLY___PERFORM_FWD__ISAPPLICABLEMATCH:
			return perform_FWD((IsApplicableMatch) arguments.get(0));
		case RulesPackage.STATION_SUPPLY___IS_APPLICABLE_FWD__MATCH:
			return isApplicable_FWD((Match) arguments.get(0));
		case RulesPackage.STATION_SUPPLY___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_STATIONSUPPLY_SERVICEDELIVERYPOINT_METERASSET_METERASSETPHYSICALDEVICEPAIR:
			registerObjectsToMatch_FWD((Match) arguments.get(0),
					(gluemodel.CIM.IEC61970.LoadModel.StationSupply) arguments.get(1),
					(ServiceDeliveryPoint) arguments.get(2), (MeterAsset) arguments.get(3),
					(MeterAssetPhysicalDevicePair) arguments.get(4));
			return null;
		case RulesPackage.STATION_SUPPLY___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_STATIONSUPPLY_SERVICEDELIVERYPOINT_METERASSET_METERASSETPHYSICALDEVICEPAIR:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0),
					(gluemodel.CIM.IEC61970.LoadModel.StationSupply) arguments.get(1),
					(ServiceDeliveryPoint) arguments.get(2), (MeterAsset) arguments.get(3),
					(MeterAssetPhysicalDevicePair) arguments.get(4));
		case RulesPackage.STATION_SUPPLY___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.STATION_SUPPLY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_STATIONSUPPLY_SERVICEDELIVERYPOINT_SERVICEDELIVERYPOINT_SERVICEDELIVERYPOINTTOSERVICEDELIVERYPOINT_METERASSET_METERASSETPHYSICALDEVICEPAIR:
		...
		case RulesPackage.STATION_SUPPLY___IS_APPLICABLE_CHECK_CSP_FWD__CSP:
			return isApplicable_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.STATION_SUPPLY___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.STATION_SUPPLY___CHECK_DEC_FWD__STATIONSUPPLY_SERVICEDELIVERYPOINT_METERASSET_METERASSETPHYSICALDEVICEPAIR:
			return checkDEC_FWD((gluemodel.CIM.IEC61970.LoadModel.StationSupply) arguments.get(0),
	...
	public static final Object[] pattern_StationSupply_0_1_initialbindings_blackBBBBBB(StationSupply _this, Match match,
			gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer, ServiceDeliveryPoint srcDeliver,
			MeterAsset asset, MeterAssetPhysicalDevicePair pair) {
		return new Object[] { _this, match, srcConsumer, srcDeliver, asset, pair };
	}

	public static final Object[] pattern_StationSupply_0_2_SolveCSP_bindingFBBBBBB(StationSupply _this, Match match,
			gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer, ServiceDeliveryPoint srcDeliver,
			MeterAsset asset, MeterAssetPhysicalDevicePair pair) {
	...
	public static final Object[] pattern_StationSupply_0_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_StationSupply_0_2_SolveCSP_bindingAndBlackFBBBBBB(StationSupply _this,
			Match match, gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer, ServiceDeliveryPoint srcDeliver,
			MeterAsset asset, MeterAssetPhysicalDevicePair pair) {
		Object[] result_pattern_StationSupply_0_2_SolveCSP_binding = pattern_StationSupply_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, srcConsumer, srcDeliver, asset, pair);
		if (result_pattern_StationSupply_0_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_StationSupply_0_2_SolveCSP_binding[0];

			Object[] result_pattern_StationSupply_0_2_SolveCSP_black = pattern_StationSupply_0_2_SolveCSP_blackB(csp);
			if (result_pattern_StationSupply_0_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_StationSupply_0_3_CheckCSP_expressionFBB(StationSupply _this, CSP csp) {
		boolean _localVariable_0 = _this.isAppropriate_checkCsp_FWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_StationSupply_0_4_collectelementstobetranslated_blackBBBBB(Match match,
			gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer, ServiceDeliveryPoint srcDeliver,
			MeterAsset asset, MeterAssetPhysicalDevicePair pair) {
		return new Object[] { match, srcConsumer, srcDeliver, asset, pair };
	}

	public static final Object[] pattern_StationSupply_0_4_collectelementstobetranslated_greenBBBFF(Match match,
			gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer, ServiceDeliveryPoint srcDeliver) {
	...
	public static final Object[] pattern_StationSupply_0_5_collectcontextelements_blackBBBBB(Match match,
			gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer, ServiceDeliveryPoint srcDeliver,
			MeterAsset asset, MeterAssetPhysicalDevicePair pair) {
		return new Object[] { match, srcConsumer, srcDeliver, asset, pair };
	}

	public static final Object[] pattern_StationSupply_0_5_collectcontextelements_greenBBBBFFF(Match match,
			ServiceDeliveryPoint srcDeliver, MeterAsset asset, MeterAssetPhysicalDevicePair pair) {
	...
	public static final void pattern_StationSupply_0_6_registerobjectstomatch_expressionBBBBBB(StationSupply _this,
			Match match, gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer, ServiceDeliveryPoint srcDeliver,
			MeterAsset asset, MeterAssetPhysicalDevicePair pair) {
	...
	public static final boolean pattern_StationSupply_0_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_StationSupply_0_8_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_StationSupply_1_1_performtransformation_bindingFFFFFFB(
		...
		if (tmpSrcConsumer instanceof gluemodel.CIM.IEC61970.LoadModel.StationSupply) {
			gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer = (gluemodel.CIM.IEC61970.LoadModel.StationSupply) tmpSrcConsumer;
	...
	public static final Object[] pattern_StationSupply_1_1_performtransformation_blackBBBBBBFBB(
			gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer, ServiceDeliveryPoint srcDeliver,
			outagePreventionJointarget.ServiceDeliveryPoint trgDeliver,
			ServiceDeliveryPointToServiceDeliveryPoint deliverToDeliver, MeterAsset asset,
			MeterAssetPhysicalDevicePair pair, StationSupply _this, IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_StationSupply_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
			StationSupply _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_StationSupply_1_1_performtransformation_binding = pattern_StationSupply_1_1_performtransformation_bindingFFFFFFB(
				isApplicableMatch);
		if (result_pattern_StationSupply_1_1_performtransformation_binding != null) {
			gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer = (gluemodel.CIM.IEC61970.LoadModel.StationSupply) result_pattern_StationSupply_1_1_performtransformation_binding[0];
			ServiceDeliveryPoint srcDeliver = (ServiceDeliveryPoint) result_pattern_StationSupply_1_1_performtransformation_binding[1];
			outagePreventionJointarget.ServiceDeliveryPoint trgDeliver = (outagePreventionJointarget.ServiceDeliveryPoint) result_pattern_StationSupply_1_1_performtransformation_binding[2];
			ServiceDeliveryPointToServiceDeliveryPoint deliverToDeliver = (ServiceDeliveryPointToServiceDeliveryPoint) result_pattern_StationSupply_1_1_performtransformation_binding[3];
			MeterAsset asset = (MeterAsset) result_pattern_StationSupply_1_1_performtransformation_binding[4];
			MeterAssetPhysicalDevicePair pair = (MeterAssetPhysicalDevicePair) result_pattern_StationSupply_1_1_performtransformation_binding[5];

			Object[] result_pattern_StationSupply_1_1_performtransformation_black = pattern_StationSupply_1_1_performtransformation_blackBBBBBBFBB(
					srcConsumer, srcDeliver, trgDeliver, deliverToDeliver, asset, pair, _this, isApplicableMatch);
			if (result_pattern_StationSupply_1_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_StationSupply_1_1_performtransformation_black[6];
	...
	public static final Object[] pattern_StationSupply_1_1_performtransformation_greenBBFFB(
			gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer,
		...
		EnergyConsumer trgConsumer = OutagePreventionJointargetFactory.eINSTANCE.createEnergyConsumer();
	...
	public static final Object[] pattern_StationSupply_1_2_collecttranslatedelements_blackBBB(
			gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer,
			EnergyConsumerToEnergyConsumer consumerToConsumer, EnergyConsumer trgConsumer) {
		return new Object[] { srcConsumer, consumerToConsumer, trgConsumer };
	}

	public static final Object[] pattern_StationSupply_1_2_collecttranslatedelements_greenFBBB(
			gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer,
			EnergyConsumerToEnergyConsumer consumerToConsumer, EnergyConsumer trgConsumer) {
	...
	public static final Object[] pattern_StationSupply_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject srcConsumer, EObject srcDeliver, EObject trgDeliver,
		...
		EMoflonEdge srcDeliver__srcConsumer____EnergyConsumer = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge srcConsumer__srcDeliver____ServiceDeliveryPoints = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		String ruleresult_ruleName_prime = "StationSupply";
	...
	public static final void pattern_StationSupply_1_5_registerobjects_expressionBBBBBBBBBB(StationSupply _this,
			PerformRuleResult ruleresult, EObject srcConsumer, EObject srcDeliver, EObject trgDeliver,
			EObject deliverToDeliver, EObject consumerToConsumer, EObject asset, EObject pair, EObject trgConsumer) {
	...
	public static final PerformRuleResult pattern_StationSupply_1_6_expressionFB(PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_StationSupply_2_1_preparereturnvalue_bindingFB(StationSupply _this) {
	...
	public static final Object[] pattern_StationSupply_2_1_preparereturnvalue_blackFBB(EClass eClass,
			StationSupply _this) {
	...
	public static final Object[] pattern_StationSupply_2_1_preparereturnvalue_bindingAndBlackFFB(StationSupply _this) {
		Object[] result_pattern_StationSupply_2_1_preparereturnvalue_binding = pattern_StationSupply_2_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_StationSupply_2_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_StationSupply_2_1_preparereturnvalue_binding[0];

			Object[] result_pattern_StationSupply_2_1_preparereturnvalue_black = pattern_StationSupply_2_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_StationSupply_2_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_StationSupply_2_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_StationSupply_2_1_preparereturnvalue_greenBF(EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = Boolean.valueOf(false);
		String ruleresult_rule_prime = "StationSupply";
	...
	public static final Object[] pattern_StationSupply_2_2_corematch_bindingFFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_StationSupply_2_2_corematch_blackBBFFBBB(
			gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer, ServiceDeliveryPoint srcDeliver,
	...
	public static final Object[] pattern_StationSupply_2_3_findcontext_greenBBBBBBFFFFFFFF(
			gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer, ServiceDeliveryPoint srcDeliver,
			outagePreventionJointarget.ServiceDeliveryPoint trgDeliver,
			ServiceDeliveryPointToServiceDeliveryPoint deliverToDeliver, MeterAsset asset,
			MeterAssetPhysicalDevicePair pair) {
	...
	public static final Object[] pattern_StationSupply_2_4_solveCSP_bindingFBBBBBBBB(StationSupply _this,
			IsApplicableMatch isApplicableMatch, gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer,
	...
	public static final Object[] pattern_StationSupply_2_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_StationSupply_2_4_solveCSP_bindingAndBlackFBBBBBBBB(StationSupply _this,
			IsApplicableMatch isApplicableMatch, gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer,
			ServiceDeliveryPoint srcDeliver, outagePreventionJointarget.ServiceDeliveryPoint trgDeliver,
			ServiceDeliveryPointToServiceDeliveryPoint deliverToDeliver, MeterAsset asset,
			MeterAssetPhysicalDevicePair pair) {
		Object[] result_pattern_StationSupply_2_4_solveCSP_binding = pattern_StationSupply_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, srcConsumer, srcDeliver, trgDeliver, deliverToDeliver, asset, pair);
		if (result_pattern_StationSupply_2_4_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_StationSupply_2_4_solveCSP_binding[0];

			Object[] result_pattern_StationSupply_2_4_solveCSP_black = pattern_StationSupply_2_4_solveCSP_blackB(csp);
			if (result_pattern_StationSupply_2_4_solveCSP_black != null) {
	...
	public static final boolean pattern_StationSupply_2_5_checkCSP_expressionFBB(StationSupply _this, CSP csp) {
		boolean _localVariable_0 = _this.isApplicable_checkCsp_FWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_StationSupply_2_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_StationSupply_2_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "StationSupply";
		ruleresult.setSuccess(Boolean.valueOf(ruleresult_success_prime));
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final IsApplicableRuleResult pattern_StationSupply_2_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_StationSupply_10_1_preparereturnvalue_bindingFB(StationSupply _this) {
		EClass _localVariable_0 = _this.eClass();
	...
	public static final Object[] pattern_StationSupply_10_1_preparereturnvalue_bindingAndBlackFFBF(
			StationSupply _this) {
		Object[] result_pattern_StationSupply_10_1_preparereturnvalue_binding = pattern_StationSupply_10_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_StationSupply_10_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_StationSupply_10_1_preparereturnvalue_binding[0];

			Object[] result_pattern_StationSupply_10_1_preparereturnvalue_black = pattern_StationSupply_10_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_StationSupply_10_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_StationSupply_10_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_StationSupply_10_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_StationSupply_10_1_preparereturnvalue_greenF() {
		EObjectContainer __result = RuntimeFactory.eINSTANCE.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Iterable<Object[]> pattern_StationSupply_10_2_testcorematchandDECs_blackFFFFB(
	...
	public static final Object[] pattern_StationSupply_10_2_testcorematchandDECs_greenFB(EClass __eClass) {
	...
	public static final boolean pattern_StationSupply_10_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			StationSupply _this, Match match, gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer,
			ServiceDeliveryPoint srcDeliver, MeterAsset asset, MeterAssetPhysicalDevicePair pair) {
	...
	public static final boolean pattern_StationSupply_10_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			StationSupply _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_StationSupply_10_5_Addmatchtoruleresult_blackBBBB(Match match,
	...
	public static final Object[] pattern_StationSupply_10_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
	...
	public static final EObjectContainer pattern_StationSupply_10_6_expressionFB(EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_StationSupply_13_1_matchtggpattern_blackBBBB(
			gluemodel.CIM.IEC61970.LoadModel.StationSupply srcConsumer, ServiceDeliveryPoint srcDeliver,
			MeterAsset asset, MeterAssetPhysicalDevicePair pair) {
		if (srcDeliver.equals(asset.getServiceDeliveryPoint())) {
			if (asset.equals(pair.getA())) {
	...
	public static final boolean pattern_StationSupply_13_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_StationSupply_13_3_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}
