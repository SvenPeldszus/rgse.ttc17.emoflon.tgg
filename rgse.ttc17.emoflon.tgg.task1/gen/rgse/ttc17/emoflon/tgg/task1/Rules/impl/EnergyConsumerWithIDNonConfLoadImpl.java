...
import rgse.ttc17.emoflon.tgg.task1.Rules.EnergyConsumerWithIDNonConfLoad;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Energy Consumer With ID Non Conf Load</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class EnergyConsumerWithIDNonConfLoadImpl extends AbstractRuleImpl implements EnergyConsumerWithIDNonConfLoad {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected EnergyConsumerWithIDNonConfLoadImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RulesPackage.eINSTANCE.getEnergyConsumerWithIDNonConfLoad();
	}
	...
	public boolean isAppropriate_FWD(Match match, SubLoadArea area, ElectricityValues electric,
		...
		// initial bindings
		Object[] result1_black = EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_0_1_initialbindings_blackBBBBBBBBBBBB(this, match, area,
		...
		// Solve CSP
		Object[] result2_bindingAndBlack = EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_0_2_SolveCSP_bindingAndBlackFBBBBBBBBBBBB(this, match, area,
						electric, deliver, control, pair, asset, device, consumer, connect, group);
		...
		// Check CSP
		if (EnergyConsumerWithIDNonConfLoadImpl.pattern_EnergyConsumerWithIDNonConfLoad_0_3_CheckCSP_expressionFBB(this,
				csp)) {

			// collect elements to be translated
			Object[] result4_black = EnergyConsumerWithIDNonConfLoadImpl
					.pattern_EnergyConsumerWithIDNonConfLoad_0_4_collectelementstobetranslated_blackBBBBBBBBBBB(match,
			...
			EnergyConsumerWithIDNonConfLoadImpl
					.pattern_EnergyConsumerWithIDNonConfLoad_0_4_collectelementstobetranslated_greenBBBBFF(match, pair,
							asset, device);
			// EMoflonEdge pair__asset____a = (EMoflonEdge) result4_green[4];
			// EMoflonEdge pair__device____b = (EMoflonEdge) result4_green[5];

			// collect context elements
			Object[] result5_black = EnergyConsumerWithIDNonConfLoadImpl
					.pattern_EnergyConsumerWithIDNonConfLoad_0_5_collectcontextelements_blackBBBBBBBBBBB(match, area,
							electric, deliver, control, pair, asset, device, consumer, connect, group);
			...
			EnergyConsumerWithIDNonConfLoadImpl
					.pattern_EnergyConsumerWithIDNonConfLoad_0_5_collectcontextelements_greenBBBBBBBBBBFFFFFFFFFFFF(
							match, area, electric, deliver, control, asset, device, consumer, connect, group);
			...
			EnergyConsumerWithIDNonConfLoadImpl
					.pattern_EnergyConsumerWithIDNonConfLoad_0_6_registerobjectstomatch_expressionBBBBBBBBBBBB(this,
							match, area, electric, deliver, control, pair, asset, device, consumer, connect, group);
			return EnergyConsumerWithIDNonConfLoadImpl.pattern_EnergyConsumerWithIDNonConfLoad_0_7_expressionF();
		} else {
			return EnergyConsumerWithIDNonConfLoadImpl.pattern_EnergyConsumerWithIDNonConfLoad_0_8_expressionF();
		}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(this,
						isApplicableMatch);
		...
		NonConformLoad consumer = (NonConformLoad) result1_bindingAndBlack[7];
		AutoConnectObject connect = (AutoConnectObject) result1_bindingAndBlack[8];
		NonConformLoadGroup group = (NonConformLoadGroup) result1_bindingAndBlack[9];
		CSP csp = (CSP) result1_bindingAndBlack[10];
		Object[] result1_green = EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_greenFFBBFB(asset, device, csp);
		...
		Object[] result2_black = EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_1_2_collecttranslatedelements_blackBBBB(assetCorr, deviceCorr,
						pair, trgConsumer);
		...
		Object[] result2_green = EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_1_2_collecttranslatedelements_greenFBBBB(assetCorr, deviceCorr,
						pair, trgConsumer);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_1_3_bookkeepingforedges_blackBBBBBBBBBBBBBB(ruleresult, area,
		...
		EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(ruleresult,
						assetCorr, deviceCorr, pair, asset, device, trgConsumer);
		...
		// register objects
		EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_1_5_registerobjects_expressionBBBBBBBBBBBBBBB(this, ruleresult,
						area, assetCorr, electric, deliver, control, deviceCorr, pair, asset, device, consumer, connect,
						trgConsumer, group);
		return EnergyConsumerWithIDNonConfLoadImpl.pattern_EnergyConsumerWithIDNonConfLoad_1_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result1_bindingAndBlack = EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_2_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
		...
		Object[] result1_green = EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_2_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach core match
		Object[] result2_binding = EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_2_2_corematch_bindingFFFFFFFFFFB(match);
		...
		NonConformLoad consumer = (NonConformLoad) result2_binding[7];
		AutoConnectObject connect = (AutoConnectObject) result2_binding[8];
		NonConformLoadGroup group = (NonConformLoadGroup) result2_binding[9];
		for (Object[] result2_black : EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_2_2_corematch_blackBBBBBBBBBBB(area, electric, deliver,
						control, pair, asset, device, consumer, connect, group, match)) {
			// ForEach find context
			for (Object[] result3_black : EnergyConsumerWithIDNonConfLoadImpl
					.pattern_EnergyConsumerWithIDNonConfLoad_2_3_findcontext_blackBBBBBBBBBB(area, electric, deliver,
							control, pair, asset, device, consumer, connect, group)) {
				Object[] result3_green = EnergyConsumerWithIDNonConfLoadImpl
						.pattern_EnergyConsumerWithIDNonConfLoad_2_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFFF(area,
								electric, deliver, control, pair, asset, device, consumer, connect, group);
				...
				// solve CSP
				Object[] result4_bindingAndBlack = EnergyConsumerWithIDNonConfLoadImpl
						.pattern_EnergyConsumerWithIDNonConfLoad_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
				...
				// check CSP
				if (EnergyConsumerWithIDNonConfLoadImpl
						.pattern_EnergyConsumerWithIDNonConfLoad_2_5_checkCSP_expressionFBB(this, csp)) {

					// add match to rule result
					Object[] result6_black = EnergyConsumerWithIDNonConfLoadImpl
							.pattern_EnergyConsumerWithIDNonConfLoad_2_6_addmatchtoruleresult_blackBB(ruleresult,
									isApplicableMatch);
					...
					EnergyConsumerWithIDNonConfLoadImpl
							.pattern_EnergyConsumerWithIDNonConfLoad_2_6_addmatchtoruleresult_greenBB(ruleresult,
									isApplicableMatch);
		...
		return EnergyConsumerWithIDNonConfLoadImpl.pattern_EnergyConsumerWithIDNonConfLoad_2_7_expressionFB(ruleresult);
	}
	...
	public CSP isAppropriate_solveCsp_FWD(Match match, SubLoadArea area, ElectricityValues electric,
			ServiceDeliveryPoint deliver, ControlArea control, MeterAssetPhysicalDevicePair pair, MeterAsset asset,
			PhysicalDevice device, NonConformLoad consumer, AutoConnectObject connect, NonConformLoadGroup group) {// Create CSP
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, SubLoadArea area,
			...
			MeterAssetPhysicalDevicePair pair, MeterAsset asset, PhysicalDevice device, NonConformLoad consumer,
			AutoConnectObject connect, NonConformLoadGroup group) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_132(EMoflonEdge _edge_a) {
		...
		Object[] result1_green = EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_10_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_10_2_testcorematchandDECs_blackFFFFFFFFFFB(_edge_a)) {
			...
			NonConformLoad consumer = (NonConformLoad) result2_black[7];
			AutoConnectObject connect = (AutoConnectObject) result2_black[8];
			NonConformLoadGroup group = (NonConformLoadGroup) result2_black[9];
			Object[] result2_green = EnergyConsumerWithIDNonConfLoadImpl
					.pattern_EnergyConsumerWithIDNonConfLoad_10_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (EnergyConsumerWithIDNonConfLoadImpl
					.pattern_EnergyConsumerWithIDNonConfLoad_10_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBBBBBBB(
							this, match, area, electric, deliver, control, pair, asset, device, consumer, connect,
							group)) {
				// Ensure that the correct types of elements are matched
				if (EnergyConsumerWithIDNonConfLoadImpl
						.pattern_EnergyConsumerWithIDNonConfLoad_10_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = EnergyConsumerWithIDNonConfLoadImpl
							.pattern_EnergyConsumerWithIDNonConfLoad_10_5_Addmatchtoruleresult_blackBBBB(match,
					...
					EnergyConsumerWithIDNonConfLoadImpl
							.pattern_EnergyConsumerWithIDNonConfLoad_10_5_Addmatchtoruleresult_greenBBBB(match,
									__performOperation, __result, isApplicableCC);
		...
		return EnergyConsumerWithIDNonConfLoadImpl.pattern_EnergyConsumerWithIDNonConfLoad_10_6_expressionFB(__result);
	}
	...
	public AttributeConstraintsRuleResult checkAttributes_FWD(TripleMatch __tripleMatch) {
		...
		ruleResult.setRule("EnergyConsumerWithIDNonConfLoad");
		...
		eq0.setRuleName("EnergyConsumerWithIDNonConfLoad");
		eq0.solve(var_control_mRID, var_trgConsumer_ControlAreaID);

		eq1.setRuleName("EnergyConsumerWithIDNonConfLoad");
		eq1.solve(var_consumer_mRID, var_trgConsumer_ID);

		eq2.setRuleName("EnergyConsumerWithIDNonConfLoad");
		eq2.solve(var_electric_ApparentPowermL1, var_trgConsumer_PowerA);

		castBooleanToInteger3.setRuleName("EnergyConsumerWithIDNonConfLoad");
	...
	public boolean checkDEC_FWD(SubLoadArea area, ElectricityValues electric, ServiceDeliveryPoint deliver,
			...
			NonConformLoad consumer, AutoConnectObject connect, NonConformLoadGroup group) {// match tgg pattern
		Object[] result1_black = EnergyConsumerWithIDNonConfLoadImpl
				.pattern_EnergyConsumerWithIDNonConfLoad_13_1_matchtggpattern_blackBBBBBBBBBB(area, electric, deliver,
						control, pair, asset, device, consumer, connect, group);
		if (result1_black != null) {
			return EnergyConsumerWithIDNonConfLoadImpl.pattern_EnergyConsumerWithIDNonConfLoad_13_2_expressionF();
		} else {
			return EnergyConsumerWithIDNonConfLoadImpl.pattern_EnergyConsumerWithIDNonConfLoad_13_3_expressionF();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.ENERGY_CONSUMER_WITH_ID_NON_CONF_LOAD___IS_APPROPRIATE_FWD__MATCH_SUBLOADAREA_ELECTRICITYVALUES_SERVICEDELIVERYPOINT_CONTROLAREA_METERASSETPHYSICALDEVICEPAIR_METERASSET_PHYSICALDEVICE_NONCONFORMLOAD_AUTOCONNECTOBJECT_NONCONFORMLOADGROUP:
			return isAppropriate_FWD((Match) arguments.get(0), (SubLoadArea) arguments.get(1),
					...
					(MeterAsset) arguments.get(6), (PhysicalDevice) arguments.get(7), (NonConformLoad) arguments.get(8),
					(AutoConnectObject) arguments.get(9), (NonConformLoadGroup) arguments.get(10));
		case RulesPackage.ENERGY_CONSUMER_WITH_ID_NON_CONF_LOAD___PERFORM_FWD__ISAPPLICABLEMATCH:
			return perform_FWD((IsApplicableMatch) arguments.get(0));
		case RulesPackage.ENERGY_CONSUMER_WITH_ID_NON_CONF_LOAD___IS_APPLICABLE_FWD__MATCH:
			return isApplicable_FWD((Match) arguments.get(0));
		case RulesPackage.ENERGY_CONSUMER_WITH_ID_NON_CONF_LOAD___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_SUBLOADAREA_ELECTRICITYVALUES_SERVICEDELIVERYPOINT_CONTROLAREA_METERASSETPHYSICALDEVICEPAIR_METERASSET_PHYSICALDEVICE_NONCONFORMLOAD_AUTOCONNECTOBJECT_NONCONFORMLOADGROUP:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (SubLoadArea) arguments.get(1),
					...
					(AutoConnectObject) arguments.get(9), (NonConformLoadGroup) arguments.get(10));
			return null;
		case RulesPackage.ENERGY_CONSUMER_WITH_ID_NON_CONF_LOAD___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_SUBLOADAREA_ELECTRICITYVALUES_SERVICEDELIVERYPOINT_CONTROLAREA_METERASSETPHYSICALDEVICEPAIR_METERASSET_PHYSICALDEVICE_NONCONFORMLOAD_AUTOCONNECTOBJECT_NONCONFORMLOADGROUP:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0), (SubLoadArea) arguments.get(1),
					(ElectricityValues) arguments.get(2), (ServiceDeliveryPoint) arguments.get(3),
					(ControlArea) arguments.get(4), (MeterAssetPhysicalDevicePair) arguments.get(5),
					(MeterAsset) arguments.get(6), (PhysicalDevice) arguments.get(7), (NonConformLoad) arguments.get(8),
					(AutoConnectObject) arguments.get(9), (NonConformLoadGroup) arguments.get(10));
		case RulesPackage.ENERGY_CONSUMER_WITH_ID_NON_CONF_LOAD___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.ENERGY_CONSUMER_WITH_ID_NON_CONF_LOAD___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_SUBLOADAREA_ELECTRICITYVALUES_SERVICEDELIVERYPOINT_CONTROLAREA_METERASSETPHYSICALDEVICEPAIR_METERASSET_PHYSICALDEVICE_NONCONFORMLOAD_AUTOCONNECTOBJECT_NONCONFORMLOADGROUP:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (SubLoadArea) arguments.get(1),
					(ElectricityValues) arguments.get(2), (ServiceDeliveryPoint) arguments.get(3),
					(ControlArea) arguments.get(4), (MeterAssetPhysicalDevicePair) arguments.get(5),
					(MeterAsset) arguments.get(6), (PhysicalDevice) arguments.get(7), (NonConformLoad) arguments.get(8),
					(AutoConnectObject) arguments.get(9), (NonConformLoadGroup) arguments.get(10));
		case RulesPackage.ENERGY_CONSUMER_WITH_ID_NON_CONF_LOAD___IS_APPLICABLE_CHECK_CSP_FWD__CSP:
			return isApplicable_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.ENERGY_CONSUMER_WITH_ID_NON_CONF_LOAD___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.ENERGY_CONSUMER_WITH_ID_NON_CONF_LOAD___CHECK_DEC_FWD__SUBLOADAREA_ELECTRICITYVALUES_SERVICEDELIVERYPOINT_CONTROLAREA_METERASSETPHYSICALDEVICEPAIR_METERASSET_PHYSICALDEVICE_NONCONFORMLOAD_AUTOCONNECTOBJECT_NONCONFORMLOADGROUP:
			return checkDEC_FWD((SubLoadArea) arguments.get(0), (ElectricityValues) arguments.get(1),
					...
					(PhysicalDevice) arguments.get(6), (NonConformLoad) arguments.get(7),
					(AutoConnectObject) arguments.get(8), (NonConformLoadGroup) arguments.get(9));
		}
		return super.eInvoke(operationID, arguments);
	}

	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_0_1_initialbindings_blackBBBBBBBBBBBB(
			EnergyConsumerWithIDNonConfLoad _this, Match match, SubLoadArea area, ElectricityValues electric,
			ServiceDeliveryPoint deliver, ControlArea control, MeterAssetPhysicalDevicePair pair, MeterAsset asset,
			PhysicalDevice device, NonConformLoad consumer, AutoConnectObject connect, NonConformLoadGroup group) {
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_0_2_SolveCSP_bindingFBBBBBBBBBBBB(
			EnergyConsumerWithIDNonConfLoad _this, Match match, SubLoadArea area, ElectricityValues electric,
			ServiceDeliveryPoint deliver, ControlArea control, MeterAssetPhysicalDevicePair pair, MeterAsset asset,
			PhysicalDevice device, NonConformLoad consumer, AutoConnectObject connect, NonConformLoadGroup group) {
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_0_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_0_2_SolveCSP_bindingAndBlackFBBBBBBBBBBBB(
			EnergyConsumerWithIDNonConfLoad _this, Match match, SubLoadArea area, ElectricityValues electric,
			ServiceDeliveryPoint deliver, ControlArea control, MeterAssetPhysicalDevicePair pair, MeterAsset asset,
			PhysicalDevice device, NonConformLoad consumer, AutoConnectObject connect, NonConformLoadGroup group) {
		Object[] result_pattern_EnergyConsumerWithIDNonConfLoad_0_2_SolveCSP_binding = pattern_EnergyConsumerWithIDNonConfLoad_0_2_SolveCSP_bindingFBBBBBBBBBBBB(
				_this, match, area, electric, deliver, control, pair, asset, device, consumer, connect, group);
		if (result_pattern_EnergyConsumerWithIDNonConfLoad_0_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_EnergyConsumerWithIDNonConfLoad_0_2_SolveCSP_binding[0];

			Object[] result_pattern_EnergyConsumerWithIDNonConfLoad_0_2_SolveCSP_black = pattern_EnergyConsumerWithIDNonConfLoad_0_2_SolveCSP_blackB(
					csp);
			if (result_pattern_EnergyConsumerWithIDNonConfLoad_0_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_EnergyConsumerWithIDNonConfLoad_0_3_CheckCSP_expressionFBB(
			EnergyConsumerWithIDNonConfLoad _this, CSP csp) {
		boolean _localVariable_0 = _this.isAppropriate_checkCsp_FWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_0_4_collectelementstobetranslated_blackBBBBBBBBBBB(
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_0_4_collectelementstobetranslated_greenBBBBFF(
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_0_5_collectcontextelements_blackBBBBBBBBBBB(
			Match match, SubLoadArea area, ElectricityValues electric, ServiceDeliveryPoint deliver,
			ControlArea control, MeterAssetPhysicalDevicePair pair, MeterAsset asset, PhysicalDevice device,
			NonConformLoad consumer, AutoConnectObject connect, NonConformLoadGroup group) {
		return new Object[] { match, area, electric, deliver, control, pair, asset, device, consumer, connect, group };
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_0_5_collectcontextelements_greenBBBBBBBBBBFFFFFFFFFFFF(
			Match match, SubLoadArea area, ElectricityValues electric, ServiceDeliveryPoint deliver,
			ControlArea control, MeterAsset asset, PhysicalDevice device, NonConformLoad consumer,
			AutoConnectObject connect, NonConformLoadGroup group) {
	...
	public static final void pattern_EnergyConsumerWithIDNonConfLoad_0_6_registerobjectstomatch_expressionBBBBBBBBBBBB(
			EnergyConsumerWithIDNonConfLoad _this, Match match, SubLoadArea area, ElectricityValues electric,
			ServiceDeliveryPoint deliver, ControlArea control, MeterAssetPhysicalDevicePair pair, MeterAsset asset,
			PhysicalDevice device, NonConformLoad consumer, AutoConnectObject connect, NonConformLoadGroup group) {
	...
	public static final boolean pattern_EnergyConsumerWithIDNonConfLoad_0_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_EnergyConsumerWithIDNonConfLoad_0_8_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_bindingFFFFFFFFFFB(
						...
						if (tmpPair instanceof MeterAssetPhysicalDevicePair) {
							...
							if (tmpAsset instanceof MeterAsset) {
								...
								if (tmpDevice instanceof PhysicalDevice) {
									...
									if (tmpConsumer instanceof NonConformLoad) {
										NonConformLoad consumer = (NonConformLoad) tmpConsumer;
										if (tmpConnect instanceof AutoConnectObject) {
											AutoConnectObject connect = (AutoConnectObject) tmpConnect;
											if (tmpGroup instanceof NonConformLoadGroup) {
												NonConformLoadGroup group = (NonConformLoadGroup) tmpGroup;
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_blackBBBBBBBBBBFBB(
			SubLoadArea area, ElectricityValues electric, ServiceDeliveryPoint deliver, ControlArea control,
			MeterAssetPhysicalDevicePair pair, MeterAsset asset, PhysicalDevice device, NonConformLoad consumer,
			AutoConnectObject connect, NonConformLoadGroup group, EnergyConsumerWithIDNonConfLoad _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
			EnergyConsumerWithIDNonConfLoad _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_binding = pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_bindingFFFFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_binding != null) {
			SubLoadArea area = (SubLoadArea) result_pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_binding[0];
			ElectricityValues electric = (ElectricityValues) result_pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_binding[1];
			ServiceDeliveryPoint deliver = (ServiceDeliveryPoint) result_pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_binding[2];
			ControlArea control = (ControlArea) result_pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_binding[3];
			MeterAssetPhysicalDevicePair pair = (MeterAssetPhysicalDevicePair) result_pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_binding[4];
			MeterAsset asset = (MeterAsset) result_pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_binding[5];
			PhysicalDevice device = (PhysicalDevice) result_pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_binding[6];
			NonConformLoad consumer = (NonConformLoad) result_pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_binding[7];
			AutoConnectObject connect = (AutoConnectObject) result_pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_binding[8];
			NonConformLoadGroup group = (NonConformLoadGroup) result_pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_binding[9];

			Object[] result_pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_black = pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_blackBBBBBBBBBBFBB(
					area, electric, deliver, control, pair, asset, device, consumer, connect, group, _this,
					isApplicableMatch);
			if (result_pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_black[10];
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_1_1_performtransformation_greenFFBBFB(
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_1_2_collecttranslatedelements_blackBBBB(
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_1_2_collecttranslatedelements_greenFBBBB(
			MeterAssetToEnergyConsumer assetCorr, PhysicalDeviceToEnergyConsumer deviceCorr,
			MeterAssetPhysicalDevicePair pair, EnergyConsumer trgConsumer) {
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_1_3_bookkeepingforedges_blackBBBBBBBBBBBBBB(
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
		...
		EMoflonEdge pair__device____b = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		String ruleresult_ruleName_prime = "EnergyConsumerWithIDNonConfLoad";
	...
	public static final void pattern_EnergyConsumerWithIDNonConfLoad_1_5_registerobjects_expressionBBBBBBBBBBBBBBB(
			EnergyConsumerWithIDNonConfLoad _this, PerformRuleResult ruleresult, EObject area, EObject assetCorr,
	...
	public static final PerformRuleResult pattern_EnergyConsumerWithIDNonConfLoad_1_6_expressionFB(
			PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_2_1_preparereturnvalue_bindingFB(
			EnergyConsumerWithIDNonConfLoad _this) {
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_2_1_preparereturnvalue_blackFBB(EClass eClass,
			EnergyConsumerWithIDNonConfLoad _this) {
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_2_1_preparereturnvalue_bindingAndBlackFFB(
			EnergyConsumerWithIDNonConfLoad _this) {
		Object[] result_pattern_EnergyConsumerWithIDNonConfLoad_2_1_preparereturnvalue_binding = pattern_EnergyConsumerWithIDNonConfLoad_2_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_EnergyConsumerWithIDNonConfLoad_2_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_EnergyConsumerWithIDNonConfLoad_2_1_preparereturnvalue_binding[0];

			Object[] result_pattern_EnergyConsumerWithIDNonConfLoad_2_1_preparereturnvalue_black = pattern_EnergyConsumerWithIDNonConfLoad_2_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_EnergyConsumerWithIDNonConfLoad_2_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_EnergyConsumerWithIDNonConfLoad_2_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_2_1_preparereturnvalue_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = Boolean.valueOf(false);
		String ruleresult_rule_prime = "EnergyConsumerWithIDNonConfLoad";
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_2_2_corematch_bindingFFFFFFFFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_EnergyConsumerWithIDNonConfLoad_2_2_corematch_blackBBBBBBBBBBB(
			SubLoadArea area, ElectricityValues electric, ServiceDeliveryPoint deliver, ControlArea control,
			MeterAssetPhysicalDevicePair pair, MeterAsset asset, PhysicalDevice device, NonConformLoad consumer,
			AutoConnectObject connect, NonConformLoadGroup group, Match match) {
	...
	public static final Iterable<Object[]> pattern_EnergyConsumerWithIDNonConfLoad_2_3_findcontext_blackBBBBBBBBBB(
			SubLoadArea area, ElectricityValues electric, ServiceDeliveryPoint deliver, ControlArea control,
			MeterAssetPhysicalDevicePair pair, MeterAsset asset, PhysicalDevice device, NonConformLoad consumer,
			AutoConnectObject connect, NonConformLoadGroup group) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_2_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFFF(
			SubLoadArea area, ElectricityValues electric, ServiceDeliveryPoint deliver, ControlArea control,
			MeterAssetPhysicalDevicePair pair, MeterAsset asset, PhysicalDevice device, NonConformLoad consumer,
			AutoConnectObject connect, NonConformLoadGroup group) {
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_2_4_solveCSP_bindingFBBBBBBBBBBBB(
			EnergyConsumerWithIDNonConfLoad _this, IsApplicableMatch isApplicableMatch, SubLoadArea area,
			ElectricityValues electric, ServiceDeliveryPoint deliver, ControlArea control,
			MeterAssetPhysicalDevicePair pair, MeterAsset asset, PhysicalDevice device, NonConformLoad consumer,
			AutoConnectObject connect, NonConformLoadGroup group) {
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_2_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
			EnergyConsumerWithIDNonConfLoad _this, IsApplicableMatch isApplicableMatch, SubLoadArea area,
			ElectricityValues electric, ServiceDeliveryPoint deliver, ControlArea control,
			MeterAssetPhysicalDevicePair pair, MeterAsset asset, PhysicalDevice device, NonConformLoad consumer,
			AutoConnectObject connect, NonConformLoadGroup group) {
		Object[] result_pattern_EnergyConsumerWithIDNonConfLoad_2_4_solveCSP_binding = pattern_EnergyConsumerWithIDNonConfLoad_2_4_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, area, electric, deliver, control, pair, asset, device, consumer, connect,
				group);
		if (result_pattern_EnergyConsumerWithIDNonConfLoad_2_4_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_EnergyConsumerWithIDNonConfLoad_2_4_solveCSP_binding[0];

			Object[] result_pattern_EnergyConsumerWithIDNonConfLoad_2_4_solveCSP_black = pattern_EnergyConsumerWithIDNonConfLoad_2_4_solveCSP_blackB(
					csp);
			if (result_pattern_EnergyConsumerWithIDNonConfLoad_2_4_solveCSP_black != null) {
	...
	public static final boolean pattern_EnergyConsumerWithIDNonConfLoad_2_5_checkCSP_expressionFBB(
			EnergyConsumerWithIDNonConfLoad _this, CSP csp) {
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_2_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_2_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "EnergyConsumerWithIDNonConfLoad";
		ruleresult.setSuccess(Boolean.valueOf(ruleresult_success_prime));
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final IsApplicableRuleResult pattern_EnergyConsumerWithIDNonConfLoad_2_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_10_1_preparereturnvalue_bindingFB(
			EnergyConsumerWithIDNonConfLoad _this) {
		EClass _localVariable_0 = _this.eClass();
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_10_1_preparereturnvalue_blackFBBF(
			EClass __eClass, EnergyConsumerWithIDNonConfLoad _this) {
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_10_1_preparereturnvalue_bindingAndBlackFFBF(
			EnergyConsumerWithIDNonConfLoad _this) {
		Object[] result_pattern_EnergyConsumerWithIDNonConfLoad_10_1_preparereturnvalue_binding = pattern_EnergyConsumerWithIDNonConfLoad_10_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_EnergyConsumerWithIDNonConfLoad_10_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_EnergyConsumerWithIDNonConfLoad_10_1_preparereturnvalue_binding[0];

			Object[] result_pattern_EnergyConsumerWithIDNonConfLoad_10_1_preparereturnvalue_black = pattern_EnergyConsumerWithIDNonConfLoad_10_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_EnergyConsumerWithIDNonConfLoad_10_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_EnergyConsumerWithIDNonConfLoad_10_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_EnergyConsumerWithIDNonConfLoad_10_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_10_1_preparereturnvalue_greenF() {
		EObjectContainer __result = RuntimeFactory.eINSTANCE.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Iterable<Object[]> pattern_EnergyConsumerWithIDNonConfLoad_10_2_testcorematchandDECs_blackFFFFFFFFFFB(
			EMoflonEdge _edge_a) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
						...
						if (deliver != null) {
							...
							if (connect != null) {
								...
								if (electric != null) {
									...
									if (tmpConsumer instanceof NonConformLoad) {
										NonConformLoad consumer = (NonConformLoad) tmpConsumer;
										NonConformLoadGroup group = consumer.getLoadGroup();
										if (group != null) {
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_10_2_testcorematchandDECs_greenFB(
			EClass __eClass) {
	...
	public static final boolean pattern_EnergyConsumerWithIDNonConfLoad_10_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBBBBBBB(
			EnergyConsumerWithIDNonConfLoad _this, Match match, SubLoadArea area, ElectricityValues electric,
			ServiceDeliveryPoint deliver, ControlArea control, MeterAssetPhysicalDevicePair pair, MeterAsset asset,
			PhysicalDevice device, NonConformLoad consumer, AutoConnectObject connect, NonConformLoadGroup group) {
	...
	public static final boolean pattern_EnergyConsumerWithIDNonConfLoad_10_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			EnergyConsumerWithIDNonConfLoad _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_10_5_Addmatchtoruleresult_blackBBBB(
	...
	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_10_5_Addmatchtoruleresult_greenBBBB(
			Match match, EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
	...
	public static final EObjectContainer pattern_EnergyConsumerWithIDNonConfLoad_10_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_EnergyConsumerWithIDNonConfLoad_13_1_matchtggpattern_blackBBBBBBBBBB(
			SubLoadArea area, ElectricityValues electric, ServiceDeliveryPoint deliver, ControlArea control,
			MeterAssetPhysicalDevicePair pair, MeterAsset asset, PhysicalDevice device, NonConformLoad consumer,
			AutoConnectObject connect, NonConformLoadGroup group) {
		if (area.equals(group.getSubLoadArea())) {
	...
	public static final boolean pattern_EnergyConsumerWithIDNonConfLoad_13_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_EnergyConsumerWithIDNonConfLoad_13_3_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}
