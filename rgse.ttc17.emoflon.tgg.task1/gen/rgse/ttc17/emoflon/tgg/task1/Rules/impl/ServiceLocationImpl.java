...
import rgse.ttc17.emoflon.tgg.task1.Rules.ServiceLocation;
...
public class ServiceLocationImpl extends AbstractRuleImpl implements ServiceLocation {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		gluemodel.CIM.IEC61968.Customers.ServiceLocation srcLocation = (gluemodel.CIM.IEC61968.Customers.ServiceLocation) result1_bindingAndBlack[1];
		...
		Object[] result2_black = ServiceLocationImpl.pattern_ServiceLocation_1_2_collecttranslatedelements_blackBBB(
		...
		Object[] result3_black = ServiceLocationImpl.pattern_ServiceLocation_1_3_bookkeepingforedges_blackBBBBBBBB(
				ruleresult, trgLocation, assetToConumer, srcLocation, asset, consumer, pair, srcLocationCorr);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MeterAssetToEnergyConsumer assetToConumer,
			gluemodel.CIM.IEC61968.Customers.ServiceLocation srcLocation, MeterAsset asset, EnergyConsumer consumer,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_4(EMoflonEdge _edge_Location) {
		// prepare return value
		Object[] result1_bindingAndBlack = ServiceLocationImpl
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.SERVICE_LOCATION___IS_APPROPRIATE_FWD__MATCH_SERVICELOCATION_METERASSET_METERASSETPHYSICALDEVICEPAIR:
		...
		case RulesPackage.SERVICE_LOCATION___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_SERVICELOCATION_METERASSET_METERASSETPHYSICALDEVICEPAIR:
			registerObjectsToMatch_FWD((Match) arguments.get(0),
					(gluemodel.CIM.IEC61968.Customers.ServiceLocation) arguments.get(1), (MeterAsset) arguments.get(2),
					(MeterAssetPhysicalDevicePair) arguments.get(3));
			return null;
		case RulesPackage.SERVICE_LOCATION___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_SERVICELOCATION_METERASSET_METERASSETPHYSICALDEVICEPAIR:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0),
					(gluemodel.CIM.IEC61968.Customers.ServiceLocation) arguments.get(1), (MeterAsset) arguments.get(2),
					(MeterAssetPhysicalDevicePair) arguments.get(3));
		case RulesPackage.SERVICE_LOCATION___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.SERVICE_LOCATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_METERASSETTOENERGYCONSUMER_SERVICELOCATION_METERASSET_ENERGYCONSUMER_METERASSETPHYSICALDEVICEPAIR:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MeterAssetToEnergyConsumer) arguments.get(1),
					(gluemodel.CIM.IEC61968.Customers.ServiceLocation) arguments.get(2), (MeterAsset) arguments.get(3),
		...
		case RulesPackage.SERVICE_LOCATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_4__EMOFLONEDGE:
		...
		case RulesPackage.SERVICE_LOCATION___CHECK_DEC_FWD__SERVICELOCATION_METERASSET_METERASSETPHYSICALDEVICEPAIR:
	...
	public static final Object[] pattern_ServiceLocation_1_1_performtransformation_blackBBBBBFBB(
			MeterAssetToEnergyConsumer assetToConumer, gluemodel.CIM.IEC61968.Customers.ServiceLocation srcLocation,
			MeterAsset asset, EnergyConsumer consumer, MeterAssetPhysicalDevicePair pair, ServiceLocation _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_ServiceLocation_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_ServiceLocation_1_1_performtransformation_binding != null) {
			MeterAssetToEnergyConsumer assetToConumer = (MeterAssetToEnergyConsumer) result_pattern_ServiceLocation_1_1_performtransformation_binding[0];
			gluemodel.CIM.IEC61968.Customers.ServiceLocation srcLocation = (gluemodel.CIM.IEC61968.Customers.ServiceLocation) result_pattern_ServiceLocation_1_1_performtransformation_binding[1];
			MeterAsset asset = (MeterAsset) result_pattern_ServiceLocation_1_1_performtransformation_binding[2];
			EnergyConsumer consumer = (EnergyConsumer) result_pattern_ServiceLocation_1_1_performtransformation_binding[3];
			MeterAssetPhysicalDevicePair pair = (MeterAssetPhysicalDevicePair) result_pattern_ServiceLocation_1_1_performtransformation_binding[4];
	...
	public static final Object[] pattern_ServiceLocation_1_1_performtransformation_greenFBBF(
			gluemodel.CIM.IEC61968.Customers.ServiceLocation srcLocation, EnergyConsumer consumer) {
	...
	public static final Object[] pattern_ServiceLocation_1_2_collecttranslatedelements_blackBBB(Location trgLocation,
			gluemodel.CIM.IEC61968.Customers.ServiceLocation srcLocation, LocationToLocation srcLocationCorr) {
	...
	public static final Iterable<Object[]> pattern_ServiceLocation_2_2_corematch_blackFBBFBB(
			gluemodel.CIM.IEC61968.Customers.ServiceLocation srcLocation, MeterAsset asset,
