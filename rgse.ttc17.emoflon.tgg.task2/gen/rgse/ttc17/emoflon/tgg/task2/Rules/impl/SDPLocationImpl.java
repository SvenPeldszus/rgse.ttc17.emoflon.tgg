...
public class SDPLocationImpl extends AbstractRuleImpl implements SDPLocation {
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : SDPLocationImpl.pattern_SDPLocation_2_2_corematch_blackBBBFFB(srcLocation, asset,
				pair, match)) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_151(EMoflonEdge _edge_Location) {
		// prepare return value
		Object[] result1_bindingAndBlack = SDPLocationImpl
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.SDP_LOCATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_SDPLOCATION_METERASSET_METERASSETMMXUPAIR_PMUVOLTAGEMETER_METERASSETTOPMUVOLTAGEMETER:
		...
		case RulesPackage.SDP_LOCATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_151__EMOFLONEDGE:
	...
	public static final Object[] pattern_SDPLocation_1_1_performtransformation_blackBBBBBFBB(
			gluemodel.CIM.IEC61968.Metering.SDPLocation srcLocation, MeterAsset asset, MeterAssetMMXUPair pair,
			PMUVoltageMeter consumer, MeterAssetToPMUVoltageMeter assetToPMU, SDPLocation _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_SDPLocation_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_SDPLocation_1_1_performtransformation_binding != null) {
			...
			MeterAssetMMXUPair pair = (MeterAssetMMXUPair) result_pattern_SDPLocation_1_1_performtransformation_binding[2];
			PMUVoltageMeter consumer = (PMUVoltageMeter) result_pattern_SDPLocation_1_1_performtransformation_binding[3];
			MeterAssetToPMUVoltageMeter assetToPMU = (MeterAssetToPMUVoltageMeter) result_pattern_SDPLocation_1_1_performtransformation_binding[4];
	...
	public static final Iterable<Object[]> pattern_SDPLocation_2_2_corematch_blackBBBFFB(
			gluemodel.CIM.IEC61968.Metering.SDPLocation srcLocation, MeterAsset asset, MeterAssetMMXUPair pair,
			Match match) {
